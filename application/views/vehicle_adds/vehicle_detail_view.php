                ...
                $.ajax({
                    ...
                    success: function(msg) {
                        if (msg != 0) {
                            ...
                            $('#seller_subscription_span').html('<i class="fa fa-check-square"></i><a style="cursor: pointer" title="Unsubscribe Seller" onclick="unsubscribe_seller(' + msg + ')">Unsubscribe Seller</a>');
                        } else {
